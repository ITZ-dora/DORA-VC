# This code is written by (C) TheTeamDORA bot will send message to log group when someone add
# this bot to new group make sure to star all projects
# Copyright (C) 2021-2024 by DORA_Help@ Github, < TheTeamDORA >.
# A Powerful Music Bot Property Of Rocks Indian Largest Chatting Group
# All rights reserved. © Alisha © DORA © Yukki

from pyrogram import Client, filters
from pyrogram.types import Message
from DORAMusic import app
from DORAMusic.utils.database import get_served_chats
